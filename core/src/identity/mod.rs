...
pub use file::{
    ...
    sanitize_profile, unlock_identity, unlock_identity_and_key, update_profile,
    update_profile_and_key, update_profile_with_key, validate_avatar, validate_nickname,
};
