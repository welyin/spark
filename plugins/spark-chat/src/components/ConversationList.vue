...
<template>
  <aside class="conv-list">
    <div class="conv-search">
      ...
      <!-- 个人过滤规则入口（communication §4.3）：本地过滤，只影响自己的视图 -->
      <el-tooltip content="个人过滤规则（本地，只影响自己的视图）" placement="bottom">
        <el-button text :icon="Setting" class="conv-filter-btn" @click="filterVisible = true" />
      </el-tooltip>
    </div>
    <FilterSettings v-model="filterVisible" />
...
import { BellFilled, Brush, Delete, MuteNotification, Remove, Search, Setting, Top } from '@element-plus/icons-vue';
...
export default defineComponent({
  ...
  components: { UserAvatar, FilterSettings, MuteNotification, Top, BellFilled, Brush, Delete, Remove },
  props: {
